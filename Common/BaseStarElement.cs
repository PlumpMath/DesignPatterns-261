...
namespace DP.Common
{
    public class BaseStarElement
    {
        ...
        public static PointF[] Calculate5StarPointsCenter(PointF orig, float outerradius, float innerradius)
        {
            ...
            pnts[1].Y -= innerradius*Cos36; // 0:06 hours
            pnts[2].X += outerradius*Sin72;
            pnts[2].Y -= outerradius*Cos72; // 0:12 hours
            pnts[3].X += innerradius*Sin72;
            pnts[3].Y += innerradius*Cos72; // 0:18
            pnts[4].X += outerradius*Sin36;
            pnts[4].Y += outerradius*Cos36; // 0:24 
        ...
        {
            return Calculate5StarPointsCenter(new PointF(orig.X + outerradius / 2, orig.Y + outerradius/2), outerradius,
                innerradius);
        }
    }
}
